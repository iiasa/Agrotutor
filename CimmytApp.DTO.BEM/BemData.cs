namespace CimmytApp.DTO.BEM
{
    ...
    public class BemData
    {
        ...
        public static async Task<BemData> LoadBEMData()
        {
            ...
            var utilidads = await RequestJson.Get<List<Utilidad>>("http://104.239.158.49/api.php?type=utilidad&tkn=E31C5F8478566357BA6875B32DC59");

            if (costo == null || ingreso == null || rendimiento == null || utilidads == null) return null;
