...
namespace Agrotutor.Modules.Weather.Types
{
    ...
    public class HourlySummary
    {
        ...
        public string WxIcon => WDT.Util.GetIconSrcForWx(WxCode);
        public string TinyWxIcon => WDT.Util.GetTinyIconSrcForWx(WxCode);
        
        public string WxText => WDT.Util.GetTextForWx(WxCode);
