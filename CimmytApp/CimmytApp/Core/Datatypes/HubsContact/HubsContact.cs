namespace CimmytApp.Core.Datatypes.HubsContact
{
    ...
    public class HubsContact
    {
        ...
        public static HubsContact FromJson(string json) => JsonConvert.DeserializeObject<HubsContact>(json, Datatypes.HubsContact.Converter.Settings);

        public static async Task<HubsContact> FromEmbeddedResource()
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            string resourceName = "CimmytApp.Resources.AppData.hubs_contact.geojson";
    ...
    {
        public static string ToJson(this HubsContact self) => JsonConvert.SerializeObject(self, CimmytApp.Core.Datatypes.HubsContact.Converter.Settings);
    }
